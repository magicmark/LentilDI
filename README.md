...
Because you like to easily test your modules, you might be passing in _all_ your dependencies (including built-in node modules) and wiring them up manually as such:
